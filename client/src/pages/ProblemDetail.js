 ...
 */
const parseTestCaseInputs = (input = '') => {
  if (!input) return [];
 ...
 */
const getJavaTypeFromSignature = (signature, fallback) => {
 ...
 */
const getJavaTypeFromTestCases = (testCases = [], fallback) => {
 ...
 */
const getJavaFallbackTypes = (questionType) => {
  switch (questionType) {
    case 'string':
 ...
 */
const sanitizeFunctionName = (title) => {
 ...
 */
const getJavaSupportDefinition = (questionType) => {
  switch (questionType) {
    case 'linked_list':
      return `/**
 ...
 */
const getJavaScriptSupportComment = (questionType) => {
  switch (questionType) {
    case 'linked_list':
      return `/**
* Definition for singly-linked list.
 ...
 */
const getPythonSupportDefinition = (questionType) => {
  switch (questionType) {
    case 'linked_list':
 ...
 */
const getCppSupportComment = (questionType) => {
  switch (questionType) {
    case 'linked_list':
      return `/**
* Definition for singly-linked list.
 ...
 */
const normalizeParameterSchema = (schema, fallbackTypes) => {
  if (!schema) {
    return {
 ...
 */
const mapCppType = (type, { isReturn = false } = {}) => {
  const base = type?.trim();
  switch (base) {
    case 'int':
      return 'int';
 ...
 */
const buildJavaTemplate = (functionName, typeInfo, questionType, parameterSchema) => {
  const fallback = {
 ...
 */
const buildJavascriptTemplate = (functionName, context) => {
 ...
 */
const buildPythonTemplate = (functionName, context) => {
 ...
 */
const buildCppTemplate = (functionName, context) => {
 ...
 */
const getCodeTemplate = (problem, language, testCases = []) => {
